...
static const char *leftmoncmd[] = { "xrandr", "--output", "eDP1", "--primary", "--auto", "--output", "DPI-3", "--left-of", "eDP1", "--auto", NULL };
static const char *rightmoncmd[] = { "xrandr", "--output", "eDP1", "--primary", "--auto", "--output", "DPI-3", "--right-of", "eDP1", "--auto", NULL };
static const char *nomoncmd[] = { "xrandr", "--output", "eDP1", "--primary", "--auto", "--output", "DPI-3", "--off", NULL };
