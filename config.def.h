...
static const Rule rules[] = {
    ...
    { "sandtrix",           NULL,       NULL,       1 << 5,       False,       0  },
    { "Minecraft",          NULL,       NULL,       1 << 5,       False,       0  },
    { "Minecraft Launcher", NULL,       NULL,       1 << 5,       False,       0  },
    { "minecraft-launcher", NULL,       NULL,       1 << 5,       False,       0  },
    { "libreoffice",        NULL,       NULL,       1 << 5,       False,       1  },
    { "jetbrains-phpstorm", NULL,       "pc-app",   1 << 0,       False,       1  },
    { "jetbrains-phpstorm", NULL,       "pc-api",   1 << 1,       False,       1  },
    { "jetbrains-pycharm",  NULL,       "pc-data",  1 << 3,       False,       1  },
    { "jetbrains-pycharm",  NULL,       "pc-ai",    1 << 4,       False,       1  },
    { "jetbrains-pycharm",  NULL,       NULL,       1 << 4,       False,       1  },
    { "jetbrains-idea-ce",  NULL,       NULL,       1 << 5,       False,       1  },
    { "rstudio",            NULL,       NULL,       1 << 3,       False,       1  },
};
...
static const char *brightnessupcmd[] = { "buf", NULL };
